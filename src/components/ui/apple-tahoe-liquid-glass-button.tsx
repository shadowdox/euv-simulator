      ...
      <>
        <svg className="absolute w-0 h-0 overflow-hidden pointer-events-none" aria-hidden="true">
          <filter id={`liquid-glass-${filterId}`} primitiveUnits="objectBoundingBox">
            ...
            <feDisplacementMap id="disp" in="blur" in2="map" scale="0.5"
        ...
        <style>{`
          .btn-liquid-${filterId} {
            ...
            color: var(--foreground-color, #c8d4e0);
            --glass-reflex-light: 1;
            --glass-reflex-dark: 1;
          }
          .btn-liquid-lens-${filterId} {
            background-color: ${glassColor ?? 'rgba(124, 111, 238, 0.08)'};
          ...
          .btn-liquid-text-${filterId} {
            text-shadow: 0 1px 2px rgba(3,5,10,0.30);
